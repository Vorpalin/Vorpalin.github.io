...
function ModalLink({ href, label, variant }: ModalLinkProps) {
  ...
  if (!href || href.trim() === "" || href === "#") {
    return (
      <span
        aria-disabled="true"
        title="Not available"
        className={`${base} bg-gray-800/50 text-gray-600 cursor-not-allowed select-none`}
      >
        {label}
      </span>
    );
  ...
  const colors =
    variant === "primary"
      ...
      : "bg-gray-800 hover:bg-purple-800 text-gray-400";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
        {(projects as Project[]).map((project) => (
          <div
            ...
            className="flex min-w-0 flex-col border border-white bg-gray-900 backdrop-blur-md rounded-2xl shadow-lg overflow-hidden cursor-pointer transition duration-300 sm:hover:-translate-y-2 hover:shadow-purple-500/50"
          >
      ...
      {selectedProject && (
        ...
        >
          ...
          >
            ...
            <div className="sticky top-0 z-10 flex justify-end bg-gray-900/90 backdrop-blur px-4 py-2">
              <button
                onClick={handleCloseModal}
                aria-label="Close"
            ...
            <div className="flex flex-col">
              ...
              <div className="p-4 sm:p-6 lg:p-8">
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-3 sm:mb-4 break-words">
                  {selectedProject.title}
                </h3>
                <p className="text-gray-400 mb-4 sm:mb-6 text-sm lg:text-base">
