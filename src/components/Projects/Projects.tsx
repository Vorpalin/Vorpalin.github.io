...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Creating a Space Invaders game in 68000 assembly language.",
  ...
  {
    title: "AFIT",
    description: "Creation of cryptography methods in OCaml.",
      ...
      <div className="carousel-indicators">
        {projects.map((project, index) => (
          <button
            key={project.title}
            className={
              index === currentProject ? "carousel-dot active" : "carousel-dot"
            }
